...
export default function ProductPage() {
  return (
    <main className="product-cinema min-h-dvh overflow-hidden text-zinc-100">
      <header className="fixed inset-x-0 top-0 z-30 border-b border-white/10 bg-dark-900/90 px-5 safe-top">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between">
          ...
          <Link
            href="/"
            className="inline-flex h-10 items-center gap-2 rounded-lg bg-cyan-300 px-4 text-xs font-semibold text-[#031014] transition-colors duration-150 hover:bg-cyan-200"
          >
            开始使用
        ...
        <div className="grid w-full items-center gap-14 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="cinema-reveal">
            ...
            <p className="mt-7 max-w-xl text-pretty text-base leading-8 text-zinc-400">
              PM Brainstorm 是面向产品经理的 AI 决策推演系统。
              它不是另一个聊天机器人，而是一间随时待命的产品作战室：
              负责澄清问题、制造观点冲突、沉淀结构，并审计你的方案。
            </p>
            <div className="mt-9 flex flex-wrap gap-3">
              <Link
                href="/"
                className="inline-flex h-12 items-center gap-2 rounded-lg bg-cyan-300 px-6 text-sm font-semibold text-[#031014] hover:bg-cyan-200"
              >
                进入决策空间
              ...
              <a
                href="#how-it-works"
                className="inline-flex h-12 items-center gap-2 rounded-lg border border-white/15 px-6 text-sm font-medium text-zinc-300 hover:border-white/30 hover:text-white"
              >
                <PlayIcon size={15} />
                观看工作方式
              </a>
          ...
          <div className="film-frame cinema-reveal rounded-2xl p-5 md:p-8">
            ...
            <div className="grid gap-5 sm:grid-cols-[1.1fr_0.9fr]">
              <div className="rounded-xl border border-white/10 bg-black/20 p-4">
                ...
                <svg viewBox="0 0 420 170" className="mt-4 w-full" role="img" aria-label="产品风险趋势图">
                  ...
                  <path
                    d="M0 140 C55 132 70 86 122 101 S205 126 245 72 S330 36 420 49 V170 H0Z"
                    fill="url(#area)"
                  />
                  <path
                    d="M0 140 C55 132 70 86 122 101 S205 126 245 72 S330 36 420 49"
                    fill="none"
                    stroke="#67e8f9"
                    strokeWidth="3"
                  />
            ...
            <div className="mt-5 grid grid-cols-3 gap-px overflow-hidden rounded-lg border border-white/10 bg-white/10 text-center">
              {[
                ...
                <div key={label} className="bg-dark-800 px-3 py-4">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-px overflow-hidden rounded-xl border border-white/10 bg-white/10 md:grid-cols-2">
            {CAPABILITIES.map((item) => {
              ...
              return (
                <article key={item.title} className="group bg-[#090f16] p-7 transition-colors duration-150 hover:bg-[#0c151f]">
      ...
      <section id="how-it-works" className="scroll-mt-20 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-7xl">
      ...
      <section className="border-t border-white/10 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <Link
            href="/"
            className="mt-9 inline-flex h-12 items-center gap-2 rounded-lg bg-cyan-300 px-7 text-sm font-semibold text-[#031014] hover:bg-cyan-200"
          >
            创建第一次产品推演
            <ArrowRightIcon size={15} />
          </Link>
      ...
      <footer className="border-t border-white/10 px-5 py-8">
        <div className="mx-auto flex max-w-7xl items-center justify-between text-[10px] text-zinc-400">
